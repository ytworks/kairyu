"""Pluggable Python execution for code-scored product verification workloads.
...
_CONTAINER_LABEL = "io.kairyu-verification-exec=true"
...
class LocalExecutionRunner:
    ...
    def run_python(
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(prefix="kairyu-verification-") as tmp:
            workdir = Path(tmp)
            _stage_inputs(
                workdir,
                code=code,
...
class DockerExecutionRunner:
    ...
    def __init__(
        ...
        *,
        ...
        self._name_factory = _name_factory or (
            lambda: f"kairyu-verification-{uuid.uuid4().hex}"
        )
        self._sleep = _sleep
    ...
    def _acquire_container(
        ...
        *,
        ...
        helper = threading.Thread(
            ...
            name="kairyu-verification-docker-create",
            daemon=True,
        )
        helper.start()
        try:
    ...
    def run_python(
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(prefix="kairyu-verification-input-") as tmp:
            input_dir = Path(tmp)
            _stage_inputs(
                input_dir,
                code=code,
            ...
            if not re.fullmatch(r"kairyu-verification-[a-z0-9][a-z0-9_.-]*", name):
