...
The pluggable runner contract lives in :mod:`verification.product.workloads.execution`.  These
...
from verification.product.workloads.execution import ExecResult, LocalExecutionRunner
