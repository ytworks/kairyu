...
SOURCE_PATH = "verification/fleet/correctness/agentic_kv_tier_f4b_bench.py"
LEGACY_SOURCE_PATH = "bench/agentic_kv_tier_f4b_bench.py"
...
def _command_options(
    ...
    *,
    ...
    _require(
        command[0].endswith((SOURCE_PATH, LEGACY_SOURCE_PATH))
...
def _validate_source(value: object) -> dict[str, object]:
    ...
    _require(source.get("script_sha256") == bound.get(script_path), "source script digest differs")
    _require(
...
def recompute_quality_manifest(
    ...
    *,
    ...
    stable_performance_bound = {
        ...
        if path not in {SOURCE_PATH, LEGACY_SOURCE_PATH}
    }
