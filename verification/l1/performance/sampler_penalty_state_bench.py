...
Examples:
    uv run python verification/l1/performance/sampler_penalty_state_bench.py --device cpu
    uv run python verification/l1/performance/sampler_penalty_state_bench.py --device cuda:0 \
