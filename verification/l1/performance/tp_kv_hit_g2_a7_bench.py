...
The fixed workload geometry comes from :mod:`verification.fleet.performance.multiturn_prefix`: 64
...
from verification.fleet.performance.multiturn_prefix import (  # noqa: E402
    NUM_SESSIONS,
...
_GATEWAY_CONFIG_PATH = (
    "/workspace/deploy/verification/qwen3-32b-multi-gpu/auto-gateway.yaml"
)
...
def _engine_config_valid(text: object, tensor_parallel_size: int) -> bool:
    ...
    expected = (
        _REPO_ROOT
        / "deploy/verification/qwen3-32b-multi-gpu/kairyu.template.yaml"
...
def _runtime_attestation_valid(
    ...
    *,
    ...
    if not (
        ...
        == "repo:deploy/verification/qwen3-32b-multi-gpu/kairyu.template.yaml"
    ...
    return (
        ...
        == (
            _REPO_ROOT
            / "deploy/verification/qwen3-32b-multi-gpu/auto-gateway.yaml"
