...
from verification.l1.performance import g2_a6_vllm_bench as a6  # noqa: E402
from verification.l1.performance import run_g2_a6_formal as formal  # noqa: E402
...
def runner_source_hashes(repo: Path) -> dict[str, str]:
    ...
    module_paths = {
        "verification/l1/performance/issue_333_proc_http_bench.py": Path(__file__).resolve(),
        "verification/l1/performance/g2_a6_vllm_bench.py": Path(a6.__file__).resolve(),
        "verification/l1/performance/run_g2_a6_formal.py": Path(formal.__file__).resolve(),
    }
