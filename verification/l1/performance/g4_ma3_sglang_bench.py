...
from verification.l1.correctness import g4_ma1_qwen3_235b_nvfp4_bench as ma1  # noqa: E402
...
CAPTURE_HELPER = "/workspace/verification/l1/performance/g4_ma3_sglang_bench.py"
...
def _kairyu_resolved_argv_valid(value: object, *, pipeline_depth: object) -> bool:
    ...
    return (
        ...
        and (
            launcher == "verification/l1/performance/g4_ma3_kairyu_server.py"
            or launcher.endswith("/verification/l1/performance/g4_ma3_kairyu_server.py")
        )
        and value[2:]
        == [
            "--pipeline-depth",
