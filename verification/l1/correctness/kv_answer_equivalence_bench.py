...
from verification.l1.correctness import kv_equivalence as gate  # noqa: E402

for _module_name, _relative_origin in (
    ("kairyu", "kairyu/__init__.py"),
    ("verification.l1.correctness.kv_equivalence", "verification/l1/correctness/kv_equivalence.py"),
):
...
def _verify_parent_artifact(
    *,
    ...
    if feature == "f2c":
        from verification.fleet.performance import kv_aware_ttft_f2c_bench as owner
        ...
        return
    if feature == "f2d":
        from verification.fleet.correctness import prefix_weight_f2d_bench as owner
        ...
        return
    if feature == "f4a":
        from verification.fleet.performance import dram_kv_tier_qwen as owner
    ...
    from verification.fleet.correctness import agentic_kv_tier_f4b_bench as owner
