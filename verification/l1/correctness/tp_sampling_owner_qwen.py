...
Examples:
    ...
    uv run python verification/l1/correctness/tp_sampling_owner_qwen.py \
...
SOURCE_PATH = "verification/l1/correctness/tp_sampling_owner_qwen.py"
SOURCE_BOUND_PATHS = (
    SOURCE_PATH,
...
def _build_requests(
    ...
    from verification.l1.correctness.parity_tp import _check_vocab_agreement
