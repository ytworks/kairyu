...
``verification/l1/correctness/g4_ma2_qwen3_235b_ep_kv_bench.py``.  ``run`` is intentionally a local
...
Usage::
    ...
    python verification/l1/correctness/g4_ma2_qwen3_235b_ep_kv_bench.py run \
      ...
      --assert-gate
    python verification/l1/correctness/g4_ma2_qwen3_235b_ep_kv_bench.py verify \
      --artifact /results/g4-ma2 --assert-gate
    python verification/l1/correctness/g4_ma2_qwen3_235b_ep_kv_bench.py replay \
      --artifact /results/g4-ma2 --assert-gate
"""
...
from verification.l1.correctness import g4_ma1_qwen3_235b_nvfp4_capture as ma1_capture  # noqa: E402
from verification.l1.performance import tp_kv_hit_g2_a7_bench as a7  # noqa: E402
