...
Run inside the retained CUDA image (see ``docs/gpu-runbook.md``):
    ...
    python verification/l1/correctness/fp8_kv_g4_ekv_bench.py measure \
...
Then independently replay the retained raw JSONL:
    ...
    python verification/l1/correctness/fp8_kv_g4_ekv_bench.py verify \
      --artifact /results/g4-ekv --assert-gate
    python verification/l1/correctness/fp8_kv_g4_ekv_bench.py replay \
      --artifact /results/g4-ekv --assert-gate
...
CALIBRATION_PATH = (
    _REPO_ROOT / "verification/l1/correctness/calibration/qwen3-32b-fp8-kv.json"
)
...
BOUND_SOURCE_FILES = (
    "Dockerfile.cuda",
    "verification/l1/correctness/calibration/qwen3-32b-fp8-kv.json",
...
LEGACY_BOUND_SOURCE_FILES = tuple(
    ...
    if path == "verification/l1/correctness/fp8_kv_g4_ekv_bench.py"
    else "bench/calibration/qwen3-32b-fp8-kv.json"
    if path == "verification/l1/correctness/calibration/qwen3-32b-fp8-kv.json"
    else path
...
def _source_snapshot_valid(value: object) -> bool:
    return (
        ...
        and set(value["files"]) in (
            set(BOUND_SOURCE_FILES),
            set(LEGACY_BOUND_SOURCE_FILES),
        )
        and all(
