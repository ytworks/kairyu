...
from verification.l1.performance import issue_333_proc_http_bench as diagnostic
from verification.l1.performance import run_g2_a6_formal as formal
...
def test_critical_source_module_mapping_is_exact_and_importable() -> None:
    ...
    repo = Path(diagnostic.__file__).resolve().parents[3]
