...
def _run(*args: str):
    return subprocess.run(
        [sys.executable, "verification/l1/correctness/parity_tp.py", *args],
...
def test_the_exact_gate_compares_counts_not_a_rounded_rate():
    ...
    source = (REPO / "verification/l1/correctness/parity_tp.py").read_text()
...
def test_provenance_identifies_the_checkpoint_by_content_not_path(tmp_path):
    ...
    from verification.l1.correctness import parity_tp
