...
For ordinary prose, the head prompt requests two trailing newlines; exact-output
requests are exempt. Synthesis also requests a leading blank line. This remains
model-dependent formatting; the parser and framework preserve generated bytes.
