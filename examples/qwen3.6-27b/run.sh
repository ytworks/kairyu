...
if [ "$gpu_count" -ne 8 ]; then
  echo "This Qwen3.6-27B example uses tensor_parallel_size=8 and requires 8 visible NVIDIA GPUs; found $gpu_count" >&2
  exit 1
fi

echo "Using all 8 visible GPUs (tensor_parallel_size=8)"
