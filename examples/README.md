...
./examples/qwen3.6-deepseek-v4-8gpu/bench.sh serving-qwen
./examples/qwen3.6-deepseek-v4-8gpu/bench.sh serving-deepseek
./examples/qwen3.6-deepseek-v4-8gpu/bench.sh terminalbench
./examples/qwen3.6-deepseek-v4-8gpu/bench.sh all
```
