...
from kairyu.bench import aggregate as aggregate_protocol
from kairyu.bench import config_ab as config_ab_protocol
from kairyu.bench import config_compare as config_statistics
from kairyu.bench import history as scoreboard_history
from kairyu.bench import store as store_protocol
from kairyu.bench import types as types_protocol
from kairyu.bench.adapters import QUANTIZATION_ROW_ORDER
from kairyu.bench.config_ab import build_config_comparison
from kairyu.bench.history import validate_run_metadata
...
def _protocol_identity() -> dict:
    ...
    try:
        resources.append(
            {
                "resource": "kairyu/bench/quant_sweep.py",
