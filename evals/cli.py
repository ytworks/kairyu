"""Checkout-only model-evaluation commands."""
...
def add_evals_parser(parser: argparse.ArgumentParser) -> None:
    from evals.adapters import suite_names
...
def _handle_run(args) -> int:
    from evals.config import build_config
...
def _handle_download(args) -> int:
    ...
    from evals.config import _split_csv
